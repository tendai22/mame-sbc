...
bool tty_osd_interface::video_init()
{
	int index;
...
void tty_osd_interface::video_exit()
{
	window_exit();
}
...
void tty_osd_interface::update(bool skip_redraw)
{
...
void tty_osd_interface::extract_video_config()
{
